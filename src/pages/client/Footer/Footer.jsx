        ...
        <div className='bg-black text-white flex flex-col items-center py-8 '>
            ...
            <div className='grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-6'>
                ...
                <div className='font-medium lg:col-span-2'>
                    ...
                    <img className='mt-4 w-24 h-16' src="https://assets.glxplay.io/web/responsive/w200/informed.png" alt="" />
                </div>
                ...
                <div className='lg:col-span-2'>
                    ...
                    <div className='flex items-center mt-4'>
                        <img className='w-24 h-16' src="https://assets.glxplay.io/web/responsive/w200/android-app-download-button.png" alt="" />
                        <img className='ms-2 w-24 h-16' src="https://assets.glxplay.io/web/responsive/w200/ios-app-download-button.png" alt="" />
                    </div>
